  ...
  return (
    <div className="bg-gradient-to-br from-secondary/50 via-primary/50 to-accent/50 text-foreground min-h-screen font-body">
      ...
      <main className="overflow-x-hidden">
        ...
        {/* Philosophy Section */}
        <section id="filosofia" className="py-24 bg-background/70">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto">
                ...
                El envejecimiento no es solo la caída del tejido. Es un cambio en la estructura y la calidad de la piel. Por eso, nuestro enfoque MINT® Architectural Lift™ no solo "levanta", sino que re-arquitecturiza tu belleza natural desde adentro hacia afuera.
                </p>
            ...
            <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
              {mapPillars.map((pillar) => (
                <div key={pillar.name} className="flex flex-col items-center">
                  ...
                  <p className="mt-2 text-muted-foreground max-w-xs mx-auto">{pillar.description}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section id="protocolos" className="py-24">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="font-headline text-4xl md:text-5xl font-bold">Descubre tu Protocolo Ideal</h2>
          ...
          <div className="mt-20 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-12">
              <div>
                  <h3 className="font-headline text-3xl font-bold mb-8 text-center md:text-left">Arquitectura Facial</h3>
                  <div className="space-y-6">
                      {facialProtocols.map((protocol) => (
                          <div key={protocol.name}>
                              <h4 className="font-semibold text-lg text-primary">{protocol.name}</h4>
               ...
               <div>
                  <h3 className="font-headline text-3xl font-bold mb-8 text-center md:text-left">Arquitectura Corporal</h3>
                  <div className="space-y-6">
      ...
      <footer className="py-12 bg-background/70">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-muted-foreground">
            <Logo />
            <p className="mt-4 text-sm">
                MINT® Architectural Lift™ &copy; {new Date().getFullYear()}. Todos los derechos reservados.
            </p>
        </div>
      </footer>
    </div>

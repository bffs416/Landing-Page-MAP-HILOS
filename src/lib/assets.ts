...
export const gluteCurveSteps: Step[] = [
    ...
    },
    {
        ...
        description: "Recomendar 3-5 sesiones iniciales de PDRN o mesoterapia con ácido hialurónico lineal, espaciadas 1 a 3 meses, para optimizar la neocolagenénesis. Repetir la aplicación de hilos tensores Fix/Cog al año.",
        imageUrl: '/step-10.jpg',
        imageHint: "immediate result",
    },
];
...
export const facialProtocols: Protocol[] = [
  {
    name: 'VectorLift™',
    description:
    ...
    imageUrl: '/facial-vectorlift.jpg',
  ...
  },
  {
    ...
    imageUrl: '/facial-rhinostructure.jpg',
  ...
  },
  {
    ...
    imageUrl: '/facial-contourneck.jpg',
...
export const corporalProtocols = [
  {
    ...
    imageUrl: '/corporal-coredefine.jpg',
  ...
  },
  {
    ...
    imageUrl: '/corporal-armcontour.jpg',
  ...
  },
  {
    ...
    imageUrl: '/corporal-glutecurve.jpg',
